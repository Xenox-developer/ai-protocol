# Archived synthetic experiment (v1)

This is historical documentation, not the current contract. Its original revision
labels are preserved below, including the inconsistent version 2 heading.
It describes `/work`, voluntary class headers, and old measurements.
Use [protocol v3](../protocol.md) for the current implementation.
